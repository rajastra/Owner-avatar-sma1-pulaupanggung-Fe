...
const KeloloProfile = () => {
   ...
   const getUsers = useCallback(async () => {
      try {
         const response = await axios.get(`${URL}/api/v1/profiles`);
      ...
      <Layout>
         ...
         >
            ...
            <Menu
               theme="dark"
               mode="inline"
               defaultSelectedKeys={['/kelolaprofile']}
               items={[
                  {
                     key: '/dashboard',
                     icon: <HomeFilled />,
         ...
         <Layout>
            ...
            >
               ...
               <div className="sub-header-name-bar">
                  <div className="name-section-bar">Data Profile</div>
               </div>
            </Header>
            <Content
               style={{
            ...
            >
               ...
               >
                  <ProfileForm open={open} closepopup={closepopup} functionopenpopup={functionopenpopup} onCreate={onCreate} />
                  <ProfileFormEdit open={isEdit} closepopup={closepopup} onEdit={onEdit} user={user} />
                  <TableProfile data={users} setUser={handleEdit} getUsers={getUsers} />
               </div>
            </Content>
            <Footer
               style={{
