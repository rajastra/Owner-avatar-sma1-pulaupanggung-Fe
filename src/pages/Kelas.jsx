...
import KelasFormEdit from '../components/KelasFormEdit';
...
const Kelas = () => {
  ...
  const getUsers = useCallback(async () => {
    try {
      const response = await axios.get(`${URL}/api/v1/classes`);
    ...
    <Layout>
      ...
      <Layout>
        ...
        >
          ...
          >
            <KelasForm open={open} closepopup={closepopup} functionopenpopup={functionopenpopup} onCreate={onCreate} />

            <KelasFormEdit open={isEdit} closepopup={closepopup} onEdit={onEdit} user={user} />
            <TableKelas data={users} setUser={handleEdit} getUsers={getUsers} />
          </div>
        </Content>
        <Footer
          style={{
